...
void NormalRgaLogOutRgaReq(struct rga_req rgaReg) {
    ALOGE("render_mode = %d rotate_mode = %d in_fence_fd = %ld handle_flag = 0x%x",
          rgaReg.render_mode, rgaReg.rotate_mode, rgaReg.in_fence_fd, rgaReg.handle_flag);
    ALOGE("src:[%lx,%lx,%lx],x-y[%d,%d],w-h[%d,%d],vw-vh[%d,%d],f=%ld, rd_mode = %d",
    ...
    ALOGE("dst:[%lx,%lx,%lx],x-y[%d,%d],w-h[%d,%d],vw-vh[%d,%d],f=%ld, rd_mode = %d",
    ...
    ALOGE("pat:[%lx,%lx,%lx],x-y[%d,%d],w-h[%d,%d],vw-vh[%d,%d],f=%ld, rd_mode = %d",
    ...
    ALOGE("color:[%lx,%lx,%lx,%lx,%x]", rgaReg.color_key_max, rgaReg.color_key_min,
          rgaReg.fg_color, rgaReg.bg_color, rgaReg.color_fill_mode);

    ALOGE("MMU:[%d,%lx,%lx]", rgaReg.mmu_info.mmu_en,
    ...
    ALOGE("Full CSC : EN[%d] FACTOR[%d, %d, %d, %ld], [%d, %d, %d, %ld], [%d, %d, %d, %ld]",
