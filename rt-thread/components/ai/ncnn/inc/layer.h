...
class NCNN_EXPORT Layer
{
  ...
  public:
    ...
    virtual int forward_inplace(
        std::vector<Mat> &bottom_top_blobs, const Option &opt) const;
  ...
  public:
    ...
    virtual int forward(const std::vector<VkMat> &bottom_blobs,
        ...
        VkCompute &cmd,
        const Option &opt) const;
    virtual int forward(const VkMat &bottom_blob,
        VkMat &top_blob,
        VkCompute &cmd,
        const Option &opt) const;
    ...
    virtual int forward_inplace(std::vector<VkMat> &bottom_top_blobs,
        ...
        const Option &opt) const;
    virtual int forward_inplace(
        VkMat &bottom_top_blob, VkCompute &cmd, const Option &opt) const;
  public:
