...
def gen_cproject_file(output_file_path):
    ...
    AFLAGS = AFLAGS.replace("-gdwarf-2", "")
    CFLAGS = CFLAGS.replace("-O0 -gdwarf-2", "")
    CFLAGS = CFLAGS.replace("-O2", "")
    CXXFLAGS = CXXFLAGS.replace("-O0 -gdwarf-2", "")
    CXXFLAGS = CXXFLAGS.replace("-O2", "")
