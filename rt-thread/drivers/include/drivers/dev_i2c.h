...
struct rt_i2c_bus_device_ops
{
    ...
    rt_ssize_t (*slave_xfer)(struct rt_i2c_bus_device *bus,
        struct rt_i2c_msg msgs[],
        rt_uint32_t num);
    rt_err_t (*i2c_bus_control)(
        struct rt_i2c_bus_device *bus, int cmd, void *args);
};
...
typedef rt_err_t (*__kpi_rt_i2c_driver_register)(struct rt_i2c_driver *driver);
typedef rt_err_t (*__kpi_rt_i2c_device_register)(struct rt_i2c_client *client);
 ...
 */
typedef rt_err_t (*__kpi_rt_i2c_bus_device_device_init)(
    struct rt_i2c_bus_device *bus, const char *name);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_i2c_bus_device_register)(
    struct rt_i2c_bus_device *bus, const char *bus_name);
 ...
 */
typedef struct rt_i2c_bus_device *(*__kpi_rt_i2c_bus_device_find)(
    const char *bus_name);
 ...
 */
typedef rt_ssize_t (*__kpi_rt_i2c_transfer)(
    struct rt_i2c_bus_device *bus, struct rt_i2c_msg msgs[], rt_uint32_t num);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_i2c_control)(
    struct rt_i2c_bus_device *bus, int cmd, void *args);
 ...
 * @return rt_ssize_t the actual length of transmitted
 */
typedef rt_ssize_t (*__kpi_rt_i2c_master_send)(struct rt_i2c_bus_device *bus,
    rt_uint16_t addr,
    rt_uint16_t flags,
 ...
 */
typedef rt_ssize_t (*__kpi_rt_i2c_master_recv)(struct rt_i2c_bus_device *bus,
    rt_uint16_t addr,
    rt_uint16_t flags,
    rt_uint8_t *buf,
    rt_uint32_t count);

rt_inline rt_err_t rt_i2c_bus_lock(
    struct rt_i2c_bus_device *bus, rt_tick_t timeout)
{
...
KPI_EXTERN(rt_i2c_driver_register);
KPI_EXTERN(rt_i2c_device_register);
KPI_EXTERN(rt_i2c_bus_device_device_init);
KPI_EXTERN(rt_i2c_bus_device_register);
KPI_EXTERN(rt_i2c_bus_device_find);
KPI_EXTERN(rt_i2c_transfer);
KPI_EXTERN(rt_i2c_control);
KPI_EXTERN(rt_i2c_master_send);
KPI_EXTERN(rt_i2c_master_recv);
