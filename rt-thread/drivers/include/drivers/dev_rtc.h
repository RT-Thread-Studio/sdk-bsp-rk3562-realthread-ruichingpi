...
#define RT_DEVICE_CTRL_RTC_GET_TIMESPEC                                        \
    (RT_DEVICE_CTRL_BASE(RTC) + 0x07) /**< get timespec for clock_gettime */
#define RT_DEVICE_CTRL_RTC_SET_TIMESPEC                                        \
    (RT_DEVICE_CTRL_BASE(RTC) + 0x08) /**< set timespec for clock_settime */
#define RT_DEVICE_CTRL_RTC_GET_TIMERES                                         \
    (RT_DEVICE_CTRL_BASE(RTC) + 0x09) /**< get resolution for clock_getres */
...
rt_err_t rt_hw_rtc_register(
    rt_rtc_dev_t *rtc, const char *name, rt_uint32_t flag, void *data);
