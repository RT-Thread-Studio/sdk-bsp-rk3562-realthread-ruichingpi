...
struct rt_dac_ops
{
    ...
    rt_err_t (*convert)(
        struct rt_dac_device *device, rt_uint32_t channel, rt_uint32_t *value);
 ...
 */
typedef rt_err_t (*__kpi_rt_hw_dac_register)(rt_dac_device_t dac,
    const char *name,
    const struct rt_dac_ops *ops,
 ...
 * @return rt_err_t  error code
 */
typedef rt_err_t (*__kpi_rt_dac_write)(
    rt_dac_device_t dev, rt_uint32_t channel, rt_uint32_t value);
 ...
 * @return rt_err_t  error code
 */
typedef rt_err_t (*__kpi_rt_dac_enable)(
 ...
 * @return rt_err_t  error code
 */
typedef rt_err_t (*__kpi_rt_dac_disable)(
    rt_dac_device_t dev, rt_uint32_t channel);

KPI_EXTERN(rt_hw_dac_register);
KPI_EXTERN(rt_dac_write);
KPI_EXTERN(rt_dac_enable);
KPI_EXTERN(rt_dac_disable);
